...
youtube_dataset = load_dataset("lion-ai/youtube_asr", split="train")
...
gemini_dataset = gemini_dataset.remove_columns(["prompt"])  # Remove unused columns if any
...
combined_dataset = combined_dataset.filter(filter_by_duration, load_from_cache_file=False, num_proc=4)
